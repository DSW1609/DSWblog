				...
				<form method="post" action="" style="position: absolute;margin-top:20px;margin-left: 20px;line-height: 38px;">
					...
					<?
						...
						<table width="98%">
							...
							<tr>
								<td align="center"><input type="submit" name="dl" style="width: 252px;height: 35px;font-size: 20px; margin-left: 3px;background-color:rgba(250,152,141,1.00);cursor: pointer;border: rgba(250,152,141,1.00) solid" value="登录"></td>
							</tr>

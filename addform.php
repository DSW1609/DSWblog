...
<form method="post" action = "insert.php">     
 ...
 <div class="lynr" style="width: 1200px;height:100px;position: relative;margin-top: 10px;margin-left: 10px;">
								...
								<div class="lynr2">
									<div class="title" style="margin-left: 10px;"><a>标题：</a><input type="text" name ="title" style="width: 204px;height: 22px;">
									</div>
									<div class="author" style="position: absolute;margin-top: -20px;margin-left: 10px;"><a>作者：</a><input style="width: 204px;height: 22px;" type="text" name ="author">
									</div>
									<div class="Email" style="position: absolute;margin-top: 22px;margin-left: 10px;"><a>邮箱：</a><input style="width: 204px;height: 22px;" type="text" name ="Email">
									</div>
									...
									<div class="content" style="margin-left: 70px; margin-top: 78px;"><textarea name="content"  cols="22" rows = "4"></textarea>
									</div>
								</div>
	                        </div>
